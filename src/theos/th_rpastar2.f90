 FUNCTION th_rpastar2(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
ilr: if( newcomp_required ) then
      ...
      ! linear polymer componenet, here: same for labelled admixture and matrix
