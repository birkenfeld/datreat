 FUNCTION th_rpastr3t(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
!       --------------> set the parameter names --->
        ...
        parnam (34) = 're_me_ci'  ! re (d(t) at infinite time
...
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(34,idesc) = " infinite time value of re coarsely mdelling d(t) (matrix)" !//cr//parspace//&
        th_param_desc(35,idesc) = " time cnstant of tube dilatation d(t)" !//cr//parspace//&
...
i1:  if( mode == 0 ) then     ! normal spin-echo
      ...
      allparams(1:45) = [ wl4star, dble(narmeff), diffstar, locr2_b, locr2_a, locr2_ta, locr2_lz, locr2_te, &
