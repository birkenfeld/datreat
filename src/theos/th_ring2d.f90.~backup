 FUNCTION th_ring2d(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! 
     ...
     call Nrouse_ring2d(q,t,N, l, nu0, nue, wl4, ntrans, nwidth, pmin, pwidth, pneglim, pposlim, nuan, &
...
! subroutines and functions entered here are private to this theory and share its variables 
       subroutine Nrouse_ring2d(q,t,N, l, nu0, nue, wl4, ntrans, nwidth, pmin, pwidth, pneglim, pposlim, nuan, &
                                diff, r021, alpha, r022, beta, a_cross, Rg, Sq, Sqt)
!      ================================================================================================
!
...
! and the com diffusion
       ...
       end subroutine Nrouse_ring2d

 
 end function th_ring2d
