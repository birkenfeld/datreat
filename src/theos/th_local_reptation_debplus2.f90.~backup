 FUNCTION th_locredp2(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! ------------------------------------------------------------------
! 
!!     sqt0 =  local_reptationdr( q, teps, a, W, n, ne,  b)
!!     sqt  =  local_reptationdr( q, t,    a, W, n, ne,  b)
     sqt0 =  local_reptationdr( q, teps, a, W, n, ne,  b)
...
!     Sqdebt = ampdebye * Sqdebt 
 ...
 ! write(*,*)"q,t=",q,t,"  sqt0, sqt=",sqt0,sqt, "debye=", Sqdeb0,Sqdebt
     ...
     th_locredp2 = ampli * ( sqt + Sqdebt)/(sqt0 +Sqdeb0)
