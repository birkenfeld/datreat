 FUNCTION th_nrouspm4(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! the reout parameter representation 
     ...
     double precision :: aptrans, apwidth,  ap1
...
!      modeamp(1:11)  =  atan(abs(pa(10:20)))*2/Pi !! possibly modify the first 11
      do i=1,n_segmen
        modeamp(i) = ap1 + (1d0-ap1)*fermi( dble(i) , aptrans, apwidth )  
      enddo
...
!     Dr  = com_diff * 1d-9 / 1d-16  ! in A**2/ns
     ...
     call nrouspm4(q,t,temp,Dr,wl4,n_segmen,Re, W, l,labelarray, modeamp, Sq,Sqt)
     ...
     th_nrouspm4 = amplitu * sqt/sq  * exp( -(q*q*rr/6d0) )
...
!      call parset('diff    ',sngl(Dr),iadda,ier)
 ...
 CONTAINS 
       ...
       subroutine nrouspm4(q,t,temp,Dr,wl4,N,R, W, l,labelarray, modeamplitudes, Sq,Sqt)
!      ========================================================
!
