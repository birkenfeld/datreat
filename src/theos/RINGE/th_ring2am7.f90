 FUNCTION th_ring2am7(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! >>> extract: t
    ...
    if(parameter_is_q .and. parameter_is_t) then
      write(*,*)"th_ring2am7: record parameters of ",iadda," may only contain q or t "
      th_ring2am7 = 0.0
      return
    endif
    if(.not.parameter_is_q .and. .not.parameter_is_t) then
      write(*,*)"th_ring2am7: record parameters of ",iadda," must contain either q or t "
      th_ring2am7 = 0.0
      return
    endif
! 
...
! subroutines and functions entered here are private to this theory and share its variables
       ...
       subroutine Nrouse_ring2am7(q,t,N)
!      ================================================================
!
