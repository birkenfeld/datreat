      function th_kohl_q2(x,pa,thnam,parnam,npar,idum,ini)
c     ===================================================
!
!      kohlrausch in time
...
c ---- calculate theory here -----
       ...
       is_nse = 0
       tget   = is_nse
       call         parget('nse     ',tget,iadda,ier)
       is_nse = nint(tget)     
...
!      -------------------------------------
 ...
 100   continue
        ...
        do i=1,ng
         ...
         a = 0
         b = 9.0d0/str_delta
         result  = adapint(strex_kernel2,a,b,epsilon,maxit,erraccu)*2
...
!     *   o0,i,gcenter(i),gwidth(i),gampli(i),sum
       ...
       th_kohl_q2 = a0*dwf*(1-nmg+(nmg*eisf))*sum + bkgr

       th_kohl_q2 =  th_kohl_q2 + bgr_level + bgr_slope*o0
c
       else
        t  =  x
        th_kohl_q2 = dwf * strex_2(t)
       endif
       ...
       function strex_kernel2(t)
!      ------------------------
       implicit none

       real*8 strex_kernel2, t

       real*8 Omega, str_beta, str_tau0, str_delta, strex_2
       common /cstrex2/Omega, str_beta, str_tau0, str_delta
...
!      ------------------------
       ...
       strex_2 =  exp(-(t/str_tau0)**str_beta)  
