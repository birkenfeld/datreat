 FUNCTION th_rpastr4t(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! the internal parameter representation 
     ...
     double precision :: locr2_a0      ! locrep2 parameter a
     double precision :: locr2_ainf    ! locrep2 parameter a
     ...
     double precision :: re_me0     ! Re of Me (entangle strand Re) initial value
     double precision :: re_meinf   ! Re of Me (entangle strand Re) infinite time value
     double precision :: wl4        ! rouse rate

     double precision :: lr2_b_c    ! locrep2 parameter b 
     double precision :: lr2_a_c    ! locrep2 parameter a
     double precision :: lr2_a_c0    ! locrep2 parameter a
     double precision :: lr2_a_cinf    ! locrep2 parameter a
     ...
     double precision :: re_me_c0   ! Re initial value
     double precision :: re_me_cinf ! Re infinite time value
     ...
     double precision :: tau_dt     ! tau of tube dilation
...
!       --------------> set the parameter names --->
        ...
        parnam (33) = 're_meinf'  ! re (d(t) at infinite time
        parnam (34) = 'lr_ainf '  ! a  (d(t) at infinite time
        parnam (35) = 'tau_dt  '  ! time cnstant of dt relaxation
...
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(33,idesc) = " infinite time value of re coarsely mdelling d(t)" !//cr//parspace//&
        th_param_desc(34,idesc) = " infinite time value of a  coarsely mdelling d(t) (matrix)" !//cr//parspace//&
        th_param_desc(35,idesc) = " time constant of tube dilatation d(t)" !//cr//parspace//&
...
! ---- transfer parameters -----
      ...
      re_meinf    = abs( pa(33))
      re_me_cinf  = re_meinf
      locr2_ainf  = abs( pa(34))
      lr2_a_cinf  = locr2_ainf 
      tau_dt      = abs( pa(35))
...
i1:  if( mode == 0 ) then     ! normal spin-echo
      ...
      allparams(1:47) = [ wl4star, dble(narmeff), diffstar, locr2_b, locr2_a, locr2_ta, locr2_lz, locr2_te, &
                         dble(nro_me) , re_me0,   wl4     , betadif, plimit , q , dble(narm), l, dble(f),   &
                         ...
                         dble(nro_me_c) , re_me_c0,   wl4_c     , diffmatc, betadifc, difflin, betadifl, & 
                         re_meinf, re_me_cinf, locr2_ainf, lr2_a_cinf, tau_dt ]
