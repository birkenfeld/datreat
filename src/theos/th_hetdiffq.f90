 FUNCTION th_hetdifq(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! the recin parameter representation 
     double precision :: delta, t      ! time                                                                         
! the reout parameter representation 
 
     double precision   :: qq, q
!

     double precision   :: adapint, eps=1d-9, erracc
     integer            :: maxit  = 100000
     double precision   :: sigma_multiple = 6d0
...
! >>>>> describe theory with >>>>>>> 
       ...
       th_explanation(idesc)  = " Heterogeneous diffusion modell, average of various diffusion constants"//cr//&
                                ...
                                " HERE: indepemndent variable is q**2, time =detlta is the parameter "//cr//&
                                " th   = int(w(D) * exp(-q^2 D t)  dD)"
       th_citation(idesc)     = ""
...
! >>>>> describe record parameters used >>>>>>>
        th_file_param(:,idesc) = " " 
        th_file_param(  1,idesc) = "delta = time parameter"
...
!    write(6,*) t, a,b, nrm
     t   = delta
     q   = sqrt(qq)
     th_hetdifq = ampli * adapint(lognorm_kernel,a,b, eps, maxit, erracc) / nrm
!     write(6,*) th_hetdifq
