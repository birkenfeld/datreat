      FUNCTION th_nrouse_sh2 (x, pa, thnam, parnam, npar, ini, nopar ,params,napar,mbuf) 
!     ================================================================================               
!                                                                       
! -------> nrouse_sh2 <--------
...
!  ---- calculate theory here -----
       ...
       call Nrouse_sh2(qz,tau,diffscal,Wl4,N,R, m_aver, wcut,fpos, l,dr,taulim, pfrac, Sq,Sqt)
 
       if(sqof0) then
          th_nrouse_sh2 =  a0 * Sqt
       else
          th_nrouse_sh2 =  a0 * Sqt/Sq
       endif
       ...
       subroutine Nrouse_sh2(q,t,DrScal,Wl4,Nb,R,m_aver,wcut,fpos,l,Daver,taulim,pfrac,SqAve,SqtAve)
!      ===========================================================================
!
