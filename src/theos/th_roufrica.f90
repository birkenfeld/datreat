      FUNCTION th_roufrica (x, pa, thnam, parnam, npar, ini, nopar ,params,napar,mbuf) 
!     ===================================================               
!                                                                       
! -------> rouse <--------                                              
!                                                                       
!                                    
      ...
      real :: xh
      integer :: bgr_class, bgrsel, iadda, actual_record_address
      double precision :: bgr_frac
...
!        --------------> set the number of parameters                   
         ...
         parnam (9) = 'bgr_clas'     ! discriminator according to bgr_class
         parnam (10)= 'bgr_frac'     ! fraction of bgr in this class
...
!
      ...
      if(x_is_tau) then                                                                
        sqt0   =       pericoroufrica_sqt(qz,0d0,f_arm,n_arm,Re_arm,Wl4, fric0, fricn, nfric)                                                       
        th_roufrica=  a0 * pericoroufrica_sqt(qz,tau,f_arm,n_arm,Re_arm,Wl4,fric0,fricn, nfric)/sqt0
      else
        th_roufrica=  a0 * pericoroufrica_sqt(qz,tau,f_arm,n_arm,Re_arm,Wl4, fric0, fricn, nfric)
      endif 

      if(diff .ne. 0d0) then
        th_roufrica = th_roufrica * exp(-qz*qz*diff*tau)
      endif 


      th_roufrica = th_roufrica * (1d0-bgr_frac) + bgr_frac
!     -----------------------------------------------------
...
double precision function pericoroufrica_sqt(q,t,f_arm,n_arm,Re_arm,Wl4, fric0, fricn, nfric)
!----------------------------------------------------------------------------------------------
...
!$OMP END PARALLEL DO
        ...
        pericoroufrica_sqt = (1+f_arm*(s11+(f_arm-1)*s12))/N**2
...
!        pericoroufrica_sqt = pericoroufrica_sqt * exp( -q*q* effective_diffusion * t)
!     endif
!


end function pericoroufrica_sqt

END FUNCTION th_roufrica
