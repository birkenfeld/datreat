 FUNCTION th_locrepwz(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
!?     sqt0  =  local_reptationdr2( q, teps,      a, W0, n, ne,  b, 0)
     sqt0  = 1d0
     sqt0  =  local_reptationdr2( q, 1d-4,         a, W0, n, ne,  b, 0)
...
!     Sqdebt = ampdebye * Sqdebt 
 ...
 ! write(*,*)"q,t=",q,t,"  sqt0, sqt=",sqt0,sqt, "debye=", Sqdeb0,Sqdebt
      th_locrepwz = ampli * sqt/sqt0  * Sqdebt/Sqdeb0
