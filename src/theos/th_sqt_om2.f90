 FUNCTION th_sqt_om2(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! the internal parameter representation 
     ...
     double precision :: a1_amp     ! A1 = a1_0  +  a1_qnue * q**nue_a1 + a2_qnue * q**nue_a2
     double precision :: a1_wid     ! A1 = a1_0  +  a1_qnue * q**nue_a1 + a2_qnue * q**nue_a2
     double precision :: a1_inf     ! A1 = a1_0  +  a1_qnue * q**nue_a1 + a2_qnue * q**nue_a2
     double precision :: a1_qpeak   ! A1 = a1_0  +  a1_qnue * q**nue_a1 + a2_qnue * q**nue_a2
     double precision :: fermi      ! A1 = a1_0  +  a1_qnue * q**nue_a1 + a2_qnue * q**nue_a2
...
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(17,idesc) = "low-q level of A1   "
        th_param_desc(18,idesc) = "peak-amplitude of A1  "
        th_param_desc(19,idesc) = "width of A1 peak "
        th_param_desc(20,idesc) = "large-q value of A1 "
        th_param_desc(21,idesc) = "a_qpeak   "
...
!      A1         = a1_0  +  a1_qnue * q**nue_a1 + a2_qnue * q**nue_a2
      ...
      fermi = 1d0/(1d0+exp(-(q-a1_qpeak)/(0.5d0*a1_wid)))
      A1    = a1_0 + fermi * (a1_inf-a1_0) + a1_amp *exp( -(q-a1_qpeak)**2/(2*a1_wid**2) )
