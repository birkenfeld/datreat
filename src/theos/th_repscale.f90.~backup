 FUNCTION th_repscale(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
!  generalized local repscalen expression along the lines of deGennes, 
...
!     double precision :: blocrep
     ...
     integer          :: clf   
     integer          :: mrouse     
     double precision :: ngbfloor  
     double precision :: wl4ref 
...
! >>>>> describe theory with >>>>>>> 
       ...
       th_citation(idesc)     = " Journal de Physique, 1981, 42 (5), pp.735-740. <10.1051/jphys:01981004205073500>" //cr//parspace//&
                                ...
                                " includes scaling option for q and t by fittable scaling factors "  //cr//parspace//&
                                " Nog Gaussianity term changed (reptation3 module) rep 1-Q**2 by exp(-Q**2)"
...
!       --------------> set the parameter names --->
        ...
        parnam ( 8) = 'talpmax '  !                                                    
        parnam ( 9) = 'talpwd  '  !                                                    
        parnam (10) = 'tscale  '  ! modification-factor
        ...
        parnam (14) = 'bfloorNG'  ! non-Gaussianity bfloor
        parnam (15) = 'wl4ref  '  ! non-Gaussianity bfloor
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(14,idesc) = "non-Gaussianity bfloor" !//cr//parspace//&
        th_param_desc(15,idesc) = "wl4-reference" !//cr//parspace//&
...
! >>> extract: q-value
      ...
      t        = x  * tscale * (wl4ref/wl4) / qscale**4
! 
! ------------------------------------------------------------------
! ----------------------- implementation ---------------------------
! ------------------------------------------------------------------
! 
      nonGaussianity_floor_B = ngbfloor 
...
! ---- writing computed parameters to the record >>>
      ...
      call        parset('dtube   ',sngl(sqrt(ne)*a*qscale),iadda) !     "
