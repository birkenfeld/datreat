 FUNCTION th_rpaliri(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!============================================================================
...
1111     continue
             call  ring2am7(q,t, nring, ring_ne0, lring, ring_nue, ring_nue0, ring_wl4,  &
                      ...
                      diff,alpha,beta,r021,r022,a_cross, &
                      sqtres)                       !??
            th_rpaliri = sqtres(2)/sqtres(1)

            write(*,*)"T1:",q,t,sqtres, th_rpaliri 
