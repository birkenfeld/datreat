      ...
      FUNCTION tribapr (x, pa, thnam, parnam, npar, ini, nopar ,params,napar,mbuf) 
!     ===================================================               
!                                                                       
...
! extract parameter !                                                   
      ...
      IF (ier.ne.0) then 
         WRITE (6, * ) 'tribapr-brush: q-parameter not found! set q=0.1'
         qp = 0.1 
      ENDIF 
      q = qp 
      ...
      tribapr = exp (a1) + (1 - exp (a1) ) * exp (a2)
!                                                                       
      RETURN 
      END FUNCTION tribapr
!               
