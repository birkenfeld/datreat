 FUNCTION th_reptest(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
!  generalized local reptestn expression along the lines of deGennes, 
...
! >>>>> describe theory with >>>>>>> 
       ...
       th_explanation(idesc)  = " generalized local reptestn expression along the lines of deGennes, " //cr//parspace//&
...
!       --------------> set the parameter names --->
        ...
        parnam ( 8) = 'talpmax '  !                                                    
        parnam ( 9) = 'talpwd  '  !                                                    
        parnam (10) = 'blocrep '  ! Locrep fluctuation amplitude DEFAULT=1 !
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(10,idesc) = "prefactor to locrep DEFAULT is 1 !" !//cr//parspace//&
