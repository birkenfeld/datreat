...
! the recin parameter representation 
     ...
     double precision   :: pericostar_sqt2
...
!!     sqt    =  pericostar_sqt(q,t  ,f,narmeff,Re_arm,Wl4star,diffstar)  
     sqt0   =  pericostar_sqt2(q,0d0,f,narmeff,Re_arm,Wl4star,plimit)    ! automatic diffusion if diffstar==0     
     sqt    =  pericostar_sqt2(q,t  ,f,narmeff,Re_arm,Wl4star,plimit)  
 ! fix normalization
...
double precision function pericostar_sqt2(q,t,f_arm,n_arm,Re_arm,Wl4,plim)
!-------------------------------------------------------------------------
...
!!    if(diff == 0d0) then
!!       pericostar_sqt2 = pericostar_sqt2 * exp( -q*q* wl4/(3*f_arm*n_arm*l0*l0) * t)
!!    endif
!!


end function pericostar_sqt2
