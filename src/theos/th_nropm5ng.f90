 FUNCTION th_nropm5ng(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! the reout parameter representation 
     ...
     double precision :: talphamax
     double precision :: talphawd 
...
!       --------------> set the parameter names --->
        ...
        parnam (14) = 'alpha0  '  ! NG-amplitude                   
        parnam (15) = 'talpmax '  ! maximum of NG alpha function                   
        parnam (16) = 'talpwd  '  ! width of NG alpha function                
...
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(14,idesc) = "NG amplitude " !//cr//parspace//&
        th_param_desc(15,idesc) = "NG tmax of alpha function " !//cr//parspace//&
        th_param_desc(16,idesc) = "NG width of peak in alpha function " !//cr//parspace//&
...
!     Dr  = com_diff * 1d-9 / 1d-16  ! in A**2/ns
     ...
     call nropm5ng(q,t,temp,Dr,wl4,n_segmen,Re, W, l,labelarray, modeamp, Sq,Sqt)
     ...
     th_nropm5ng = amplitu * sqt/sq  * exp( -(q*q*rr/6d0) )
...
!      call parset('diff    ',sngl(Dr),iadda,ier)
 ...
 CONTAINS 
       ...
       subroutine nropm5ng(q,t,temp,Dr,wl4,N,R, W, l,labelarray, modeamplitudes, Sq,Sqt)
!      ========================================================
!
