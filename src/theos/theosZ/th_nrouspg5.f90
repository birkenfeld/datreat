 FUNCTION th_nrouspg5(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(15,idesc) = "t of max in log distribution alpha(t)" !//cr//parspace//&
...
!     Dr  = com_diff * 1d-9 / 1d-16  ! in A**2/ns
     ...
     call nrouspg5(q,t,temp,Dr,wl4,n_segmen,Re, W, l,labelarray, modeamp, Sq,Sqt)
     ...
     th_nrouspg5 = amplitu * sqt/sq  * exp( -(q*q*rr/6d0) )
...
!      call parset('diff    ',sngl(Dr),iadda,ier)
 ...
 CONTAINS 
       ...
       subroutine nrouspg5(q,t,temp,Dr,wl4,N,R, W, l,labelarray, modeamplitudes, Sq,Sqt)
!      ========================================================
!
