 FUNCTION th_nrousefn(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! >>>>> describe theory with >>>>>>> 
       ...
       th_explanation(idesc)  = " Rouse by discrete summation with mode restriction, fix ends and var length" & 
                //cr//parspace//" replaces nrousefn, ACCELEARTED (OMP+IMPROVED ALG.) VERSION"
...
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc( 9,idesc) = "start of length summation nmin..N" !//cr//parspace//&
...
!          dr = diff
       ...
       if(sumnorm.gt.0.0d0) then
          if(sqof0) then
            ...
            th_nrousefn = sums/sumnorm
          endif
       else
          th_nrousefn = 0
       endif 
       th_nrousefn = th_nrousefn*amplitu
