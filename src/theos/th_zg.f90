       function th_zg(x,pa,thnam,parnam,npar, ini, nopar ,params,napar,mbuf) 
!      ===================================================              
!                                                                       
...
!        implicit none                                                  
        ...
        REAL(8) zzf_miu, s17aef, d01ahf, eps, errrel
        REAL(8)  o_na, o_nxi 
...
! ---- calculate theory here -----                                      
     ...
     &  o_axi.NE.axi.OR.o_amp.NE.amp) then                           
       ...
       if (changed) then 
         th_zg_0 = d01ahf(a1, a2, eps, npts, errrel, zzf_miu, lim, ifail) 
         call  setpar('th_zg_0 ',th_zg_0,nopar ,params,napar,mbuf, ier) 
        write(*,*) 'th0=', th_zg_0 
       endif 
                                                                        
       call  getpar('th_zg_0 ',th_zg_0,nopar ,params,napar,mbuf, ier) 
       th_zg = d01ahf(a1, a2, eps, npts, errrel, zzf_miu, lim, ifail) 
       th_zg = amp*th_zg/th_zg_0 
       write(*,*)'th_zg, th_zg_0, amp=',th_zg, th_zg_0, amp
!                                                                       
       return 
       END                                           
                                                                        
         real*8 function zzf_miu(a_miu) 
!====================================================================   
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!   
        implicit none 
        ...
        real*8 zzf_ro1, zzradapint, s17aef, sum_ro 
        common/com_pa/qh, akappa, eta, xi, aa, axi, amp, ti, ws, nxi, na 
        common/miuro/miu, ro 
        ...
        sum_ro = zzradapint(zzf_ro1, romin, romax, epsro, maxitro, erracro) 
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!   
        ...
        real*8 zzf_u1, zzuadapin1, s17aef, sum_u 
        common/com_pa/qh, akappa, eta, xi, aa, axi, amp, ti, ws, nxi, na 
        common/miuro/miu, ro 
        ...
        sum_u = zzuadapin1(zzf_u1, umin, umax, epsu, maxitu, erracu) 
                                                                        
        zzf_ro1 =a_ro*s17aef(qh*a_ro*sqrt(1-miu**2),ifail)*               &
...
!        write(*,*) 'omega=', omega                                     
        ...
        zzf_u1 = (1.d0-exp(-omega*ti*u**3)*s17aef(u*ro, ifail))*          &
     &        1.d0/u**3                                                 
...
!*ds                                                                    
!*ed                                                                    
       function zzradapint(f,a,b,epsilon,maxiter,erroraccu) 
!      =================================================                
!                                                                       
...
!      -----------------------------------------------------------------
    ...
    1         continue 
              ...
              xb(itop) =  xb(itop-1) 
              s(itop)  = zzrgaus8a( f, xa(itop), xb(itop) ) 
              itop             = itop +1 
              xa(itop) =  xa(itop-2) 
              xb(itop) =  xa(itop-1) 
              s(itop)  = zzrgaus8a( f, xa(itop), xb(itop) ) 
    ...
    2            continue 
         ...
         enddo 
         write(6,*)                                                     &
     &   'zzradapint fatal error iterationnumber exceeded!'               
    3    continue 
...
!-----------------------------------------------------------------------
     ...
     &          0.960289856497536d0/                                    
       ...
       do i=1,ndim2 
         sum = sum + a(i)*( f(xave+range*x(i))+ f(xave-range*x(i)) ) 
       enddo 
       zzugaus8a1 = sum * range 
                                                                        
       return 
       END                                           
!*ds                                                                    
!*ed                                                                    
       function zzuadapin1(f,a,b,epsilon,maxiter,erroraccu) 
!      =================================================                
!                                                                       
!      lokal adaptives integrationsverfahren 2te ver. wg. rekur.        
!                                                                       
...
!      -----------------------------------------------------------------
    ...
    1         continue 
              ...
              xa(itop) = (xa(itop-1)+xb(itop-1))*0.5d0 
              xb(itop) =  xb(itop-1) 
              s(itop)  = zzugaus8a1( f, xa(itop), xb(itop) ) 
              itop             = itop +1 
              xa(itop) =  xa(itop-2) 
              xb(itop) =  xa(itop-1) 
              s(itop)  = zzugaus8a1( f, xa(itop), xb(itop) ) 
    ...
    2            continue 
         ...
         enddo 
         write(6,*)                                                     &
     &   'zzuadapin1 fatal error iterationnumber exceeded!'               
    3    continue 
