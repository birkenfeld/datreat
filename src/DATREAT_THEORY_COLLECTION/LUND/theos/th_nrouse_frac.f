      function th91(x,pa,thnam,parnam,npar,ini, nopar ,params,napar,mbuf)
c     ========================================
c
c -------> nrouse <--------
c
c
       ...
       real*8    R, fraction, W, l, Sq0, Sq, Sqt
...
!         a = fn * a0 * dexp(-qzz*qzz*diff*tau)
          ...
          call Nrousefrac(qzz,tau,temp,dr,xi,N,R,fraction, W, l, Sq,Sqt)
          sum = sum + fn*Sqt       
...
c
       ...
       subroutine Nrousefrac(q,t,temp,Dr,xi,N,R,fraction, W, l,Sq,Sqt)
!      ==================================================
!
...
!
       ...
       double precision q,t,temp,Dr,xi,R, W,Sq,Sqt, fraction
       integer N, nn,mm,p
