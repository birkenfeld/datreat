           function th008(x, pa, thnam, parnam, npar,idum,ini)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
         ...
         REAL            th008, x, pa, qq, zpi, xh, vol_frac
...
!-------------------------------------------------------------------------------
         ...
         th008 = adapint(wsize_kernel_r,gu,go,epsilon,maxit,erraccu)
...
!              th008=pepep_1(Q,SLD_D20,SLD_C12E5,d_C12E5,conc,r0)
