...
!               
      integer           :: iterationcounter=0 , maxiter=0
      integer           :: i=0, itop=0, itm=0
      double precision  :: erg=0, xbb=0, error=0, erraccu=0, eps=0
      double precision   ::  s (0:maxstack)=0, xa (0:maxstack)=0, xb (0:maxstack)=0 
                                                         
!                                                                        
!                                                                       
!      -----------------------------------------------------------------

      iterationcounter=0 ; maxiter=0
      i=0; itop=0; itm=0
      erg=0; xbb=0; error=0; erraccu=0; eps=0
      s (0:maxstack)=0; xa (0:maxstack)=0; xb (0:maxstack)=0 
