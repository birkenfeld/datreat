      FUNCTION th_nrouse_x (x, pa, thnam, parnam, npar, ini, nopar ,params,napar,mbuf) 
!     ================================================================================               
!                                                                       
! -------> nrouse_x <--------                                              
!                                                                       
...
!  ---- calculate theory here -----
       ...
       call Nrouse2(qz,tau,dr,Wl4,N,R, p_trans, w_scale, a_scale, l,Sq,Sqt)
 
       if(sqof0) then
          th_nrouse_x =  a0 * Sqt
       else
          th_nrouse_x =  a0 * Sqt/Sq
       endif
       ...
       subroutine Nrouse2(q,t,Dr,Wl4,N,R,p_trans, w_scale, a_scale,l,Sq,Sqt)
!      =====================================================================
!
...
!
       ...
       double precision :: W, tau_p, kbt, Sq0, arg1, arg2
       double precision :: a0,e0, ff2, ffc,    arg10,arg20
       double precision :: aa1 , aa2

       double precision :: wscal(n), ascal(n)
...
! ---- Do the sums -----
       do nn = 1,N
        do mm = 1,N
          ...
          arg20= 0
          do p = 1,N
            tau_p = 2*W*(1-cos((pi*p)/dfloat(N))) * wscal(p)
            a0    = -t*tau_p
