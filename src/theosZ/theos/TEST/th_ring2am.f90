 FUNCTION th_ring2am(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! subroutines and functions entered here are private to this theory and share its variables
       ...
       subroutine Nrouse_ring2am(q,t,N)
!      ================================================================
!
...
!$OMP END PARALLEL DO
       ...
       end subroutine Nrouse_ring2am

 end function th_ring2am
