 FUNCTION th_nrousept(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! the internal parameter representation 
     ...
     double precision :: tscale     ! maximum mode to be included                                                     
...
!       --------------> set the parameter names --->
        ...
        parnam ( 9) = 'tscale  '  ! maximum mode to be included                                                     
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc( 9,idesc) = "time scaleinhng factor" !//cr//parspace//&
...
! 
     ...
     call nrousept(q,t,temp,Dr,wl4,n_segmen,Re, W, l,pmin,pmax, Sq,Sqt)


     th_nrousept = amplitu * sqt/sq
...
! ---- writing computed parameters to the record >>>
 ...
 CONTAINS 
       ...
       subroutine nrousept(q,t,temp,Dr,wl4,N,R, W, l,pmin,pmax, Sq,Sqt)
!      ========================================================
!
