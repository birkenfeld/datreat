      FUNCTION th_roufric3 (x, pa, thnam, parnam, npar, ini, nopar ,params,napar,mbuf) 
!     ===================================================               
!                                                                       
! -------> rouse <--------                                              
!                                                                       
!                                    
      ...
      double precision :: fric0, fricn, nfric, fricc0, fricp0
...
!        --------------> set the number of parameters                   
         ...
         parnam (7) = 'fricp0'       !      " 
         parnam (8) = 'nfric'        !      " 
         parnam (9) = 'fricc0'       ! friction modifer center
...
! ---- calculate theory here -----                                      
      ...
      if(x_is_tau) then                                                                
        sqt0   =       pericoroufric3_sqt(qz,0d0,f_arm,n_arm,Re_arm,Wl4, fric0, fricn, nfric)                                                       
        th_roufric3=  a0 * pericoroufric3_sqt(qz,tau,f_arm,n_arm,Re_arm,Wl4,fric0,fricn, nfric)/sqt0
      else
        th_roufric3=  a0 * pericoroufric3_sqt(qz,tau,f_arm,n_arm,Re_arm,Wl4, fric0, fricn, nfric)
      endif 

      if(diff .ne. 0d0) then
        th_roufric3 = th_roufric3 * exp(-qz*qz*diff*tau)
      endif 
...
double precision function pericoroufric3_sqt(q,t,f_arm,n_arm,Re_arm,Wl4, fric0, fricn, nfric)
!----------------------------------------------------------------------------------------------
...
!!
 ...
 double precision, save       :: fric00, fricn0, nfric0, fricc00, fricp00
...
!$OMP END PARALLEL DO
        ...
        pericoroufric3_sqt = (1+f_arm*(s11+(f_arm-1)*s12))/N**2
...
!        pericoroufric3_sqt = pericoroufric3_sqt * exp( -q*q* effective_diffusion * t)
!     endif
!


end function pericoroufric3_sqt
