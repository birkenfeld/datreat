...
! the internal parameter representation 
     ...
     double precision :: n          ! number of segments in one ring                                                  
...
!       --------------> set the parameter names --->
        ...
        parnam ( 9) = 'lseg    '  ! effective segment length                                                        
...
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc( 3,idesc) = "reference mean squared displacement at first transition point to medium timed diff." !//cr//parspace//&
        th_param_desc( 4,idesc) = "sub-diffusion  exponent of SHORT time diffusion" !//cr//parspace//&
        th_param_desc( 5,idesc) = "reference mean squared displacement at second transition point to D0 in [A**2]" !//cr//parspace//&
        th_param_desc( 6,idesc) = "sub-diffusion  exponent of medium time diffusion" !//cr//parspace//&
        th_param_desc( 7,idesc) = "transition exponent between short and long time diffusion (sharper kink for larger a)" !//cr//parspace//&
        th_param_desc( 8,idesc) = "number of segments in one ring" !//cr//parspace//&
        th_param_desc( 9,idesc) = "effective segment length" !//cr//parspace//&
        th_param_desc(10,idesc) = "chain statistics exponent (nu=0.5 => random walk, Gaussian)" !//cr//parspace//&
        th_param_desc(11,idesc) = "Rouse rate in [A**4/ns]" !//cr//parspace//&
        th_param_desc(12,idesc) = "transition mode number between simple ring-Rouse and large p modification" !//cr//parspace//&
        th_param_desc(13,idesc) = "sharpness of transition" !//cr//parspace//&
        th_param_desc(14,idesc) = "prefactor f(p) limit for small p values (default 1)" !//cr//parspace//&
        th_param_desc(15,idesc) = "prefactor f(p) limit for large p values (default F=0.9??) transitin width is pwidth" !//cr//parspace//&
        th_param_desc(16,idesc) = "large p tau(p) = tauinf/p**pexinf" !//cr//parspace//&
        th_param_desc(17,idesc) = "large p tau(p) = tauinf/p**pexinf" !//cr//parspace//&
