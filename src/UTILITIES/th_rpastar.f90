...
!       --------------> set the parameter names --->
        ...
        parnam (13) = 'mode    '  ! what to compute                                                
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(13,idesc) = "mode: 0 normal, >0 S(x=Q,tau) 1 lin, 2 star 3 rpa" !//cr//parspace//&
...
!     Sqt  = Plin *(phistar+philin-1d0)*(Plin *philin+Pstar *phistar)/((Plin -Pstar )*phistar-Plin )
 ...
 case (1) ! linear contribution as function of q  (next step putz calc into CONTAINS)
