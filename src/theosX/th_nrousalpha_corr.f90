 FUNCTION th_nrousalpha_corr(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
!  Rouse by discrete summation with mode restriction
!  Rouse, Doi_Edwards
      use theory_description 
      implicit none 
      real    :: th_nrousalpha_corr
...
! 
     ...
     select case(mode)
       case(0)
         call nrousalpha_corr(q,t,temp,Dr,wl4,n_segmen,Re, W, l,pmin,pmax, Sq,Sqt)
         th_nrousalpha_corr = amplitu * sqt/sq
       case(1)
         th_nrousalpha_corr = alpha(t)
       case default 
...
! the model
 ...
 end function th_nrousalpha_corr
