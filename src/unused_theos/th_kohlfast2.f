      ...
      function th_kohlfast2(x,pa,thnam,parnam,npar,idum,ini)
c     ===================================================
!
...
!      ---------------- time domain scattering function
     ...
     *                   eisf2
       ...
       double precision ::  f_rlognor, f_rlognor2, t
...
!      ----------------------
       ...
       real*8   rlnor_kernel2
       external rlnor_kernel2
       ...
       cl_t2 = t
       a    = ln_tau2-4*ln_width2
       b    = ln_tau2+4*ln_width2
        
       f_rlognor2  = a2dapint(rlnor_kernel2,a,b,epsilon,maxit,erraccu)
...
!      -----------------------
       ...
       arg1 = -(((lt-ln_tau2)/ln_width2)**2)/2d0
       arg2 = -(cl_t2/exp(lt))**ln_beta2
       ...
       rlnor_kernel2 = exp(arg)/(sqrt(2d0*Pi)*ln_width2)
