      FUNCTION th_nrouse_sh4 (x, pa, thnam, parnam, npar, ini, nopar ,params,napar,mbuf) 
!     ================================================================================               
!                                                                       
! -------> nrouse_sh4 <--------
...
!         --------------> set the number of parameters
         ...
         parnam(10)= 'mfrac   '   ! fraction of mode recobination term, default 0 or 1
...
!  ---- calculate theory here -----
       ...
       call Nrouse_sh4(qz,tau,diffscal,Wl4,N,R, m_aver, wcut,fpos, l,dr,taulim, pfrac, Sq,Sqt)
 
       if(sqof0) then
          th_nrouse_sh4 =  a0 * Sqt
       else
          th_nrouse_sh4 =  a0 * Sqt/Sq
       endif
       ...
       subroutine Nrouse_sh4(q,t,DrScal,Wl4,Nb,R,m_aver,wcut,fpos,l,Daver,taulim,pfrac,SqAve,SqtAve)
!      ===========================================================================
!
           ...
           do nn = n1,n2
            do mm = n1,n2
              ...
              do p = 1,N
                 ...
                 if(mblocks > 1) then
                    survival_time = taulim / ( (mblocks-1d0) + 2 * m_aver * pfrac )
                 else   
                    survival_time = 9d99
                 endif   
  
                   
                a0    = -t * rate_p       -  t / survival_time
