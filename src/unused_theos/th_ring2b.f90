 FUNCTION th_ring2b(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! 
     ...
     call Nrouse_ring2b(q,t,N, l, nue, wl4, pmin, pwidth, f0, finf, tauinf, pexinf, &
