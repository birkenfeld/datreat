       function th_mickincombd(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!     =====================================================      
!
...
!        --------------> set the number of parameters                   
         ...
         parnam(11) = 'epsilonr'         ! scaling of Rs in Percus Yevik S(Q)
         ipa0  (11) = .FALSE. 
                                                                        
                                         ! rho0   ACHTUNG aus Datenparameterfeld                      
         parnam(12) = 'epsilond'         ! scaling of density for percus yevik
         ipa0  (12) = .FALSE.
...
!dbg         write(6,'(e13.4,f12.6,e13.4,e13.4,f12.4,e13.4,e13.4)')q,s_of_q,Rs,den,Px,sf1,sf2
         ...
         th_mickincombd = sum * intensity * rho0 * 1d4
       ...
       th_mickincombd = 0
       write(6,*)'th_mickincombd: should not be here'
...
! parameters of the micelles via common block                           
     ...
     &                  smear_core,   smear_shell                       
       ...
       den_sh1 = den_shellmat * (P/20d0)**(2d0/3d0)
!      --------------------------------------------
!                                  ----
