      FUNCTION th_nrouse_sh3 (x, pa, thnam, parnam, npar, ini, nopar ,params,napar,mbuf) 
!     ================================================================================               
!                                                                       
! -------> nrouse_sh3 <--------
...
!  ---- calculate theory here -----
       ...
       call Nrouse_sh3(qz,tau,diffscal,Wl4,N,R, m_aver, wcut,fpos, l,dr,taulim, pfrac, Sq,Sqt)
 
       if(sqof0) then
          th_nrouse_sh3 =  a0 * Sqt
       else
          th_nrouse_sh3 =  a0 * Sqt/Sq
       endif
       ...
       subroutine Nrouse_sh3(q,t,DrScal,Wl4,Nb,R,m_aver,wcut,fpos,l,Daver,taulim,pfrac,SqAve,SqtAve)
!      ===========================================================================
!
              ...
              do p = 1,N
                 ...
                 if(taulim > 0d0) then
                   ...
                   if(mblocks > 1) then
                      ...
                      survival_time = taulim / ( (mblocks-1d0) + 2 * m_aver )
                      wmode = exp(-1d0/(rate_p*survival_time))        
                   else
                      wmode = 1d0
                   endif   
                endif   
