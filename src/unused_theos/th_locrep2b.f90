 FUNCTION th_locrep2b(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
!     double precision :: local_reptation2, sqt, sqt0
     ...
     double precision :: tshift = 0
     double precision :: tlim   = 0
...
!       --------------> set the parameter names --->
        ...
        parnam ( 7) = 'tshift  '  ! near zero for t=0 evaluation                                                                    
        parnam ( 8) = 'tlim    '  ! initial time limit                                                                    
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc( 7,idesc) = "t shift of local reptation" !//cr//parspace//&
        th_param_desc( 7,idesc) = "tlimit where data start" !//cr//parspace//&
...
! 
     if(t<tlim) then
      ...
      sqt0 =  local_reptation2( q*a,    teps   /tau,  b, lz)
      sqt  =  local_reptation2( q*a, (t+tshift)/tau, b, lz)
     endif
     th_locrep2b = ampli * sqt/sqt0
