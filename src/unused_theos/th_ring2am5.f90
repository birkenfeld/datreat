 FUNCTION th_ring2am5(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! >>> extract: mw
      ...
      if(ier .ne. 0) then 
         write(*,*)"ERROR: ring2am5 requires presence of parameter mw in data record!"
         return
      endif
      mw        = xh

    if(parameter_is_q .and. parameter_is_t) then
      write(*,*)"th_ring2am5: record parameters of ",iadda," may only contain q or t "
      th_ring2am5 = 0.0
      return
    endif
    if(.not.parameter_is_q .and. .not.parameter_is_t) then
      write(*,*)"th_ring2am5: record parameters of ",iadda," must contain either q or t "
      th_ring2am5 = 0.0
      return
    endif
! 
...
! subroutines and functions entered here are private to this theory and share its variables
       ...
       subroutine Nrouse_ring2am5(q,t,N)
!      ================================================================
!
...
!$OMP END PARALLEL DO
       ...
       end subroutine Nrouse_ring2am5

 end function th_ring2am5
