      FUNCTION th_nrouse_sh22 (x, pa, thnam, parnam, npar, ini, nopar ,params,napar,mbuf) 
!     ================================================================================               
!                                                                       
! -------> nrouse_sh2 <--------
...
!                
      ...
      double precision :: temp, tau, q, wl4, l , taulim, pfrac
...
!  ---- calculate theory here -----
       ...
       call Nrouse_sh22(qz,tau,diffscal,Wl4,N,R, m_aver, wcut,fpos, l,dr,taulim, pfrac, Sq,Sqt)
 
       if(sqof0) then
          th_nrouse_sh22 =  a0 * Sqt
       else
          th_nrouse_sh22 =  a0 * Sqt/Sq
       endif
       ...
       subroutine Nrouse_sh22(q,t,DrScal,Wl4,Nb,R,m_aver,wcut,fpos,l,Daver,taulim,pfrac,SqAve,SqtAve)
!      ===========================================================================
!
