 FUNCTION th_rpalin2b(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
!       --------------> set the parameter names --->
        ...
        parnam (33+2) = 'anisod  '  ! diffusion anisotropy
...
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(33+2,idesc) = " anisotropy of diffusion " !//cr//parspace//&
...
! ---- transfer parameters -----
      ...
      anisod   = abs( pa(33+2))  ! parameter in rpa_laplace
...
i1:  if( mode == 0 ) then     ! normal spin-echo
      ...
      allparams(1:52) = [ wl4rous, dble(nrouseff), locr2_b, locr2_a, locr2_ta, locr2_lz, locr2_te, &
                         ...
                         dble(mode), dble(modeex), dble(nxpoints), t0, tmax, rlow, anisod ]  
