 FUNCTION th_locrep2nr(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! >>>>> describe theory with >>>>>>> 
       ...
       th_explanation(idesc)  = " generalized local reptation expression along the lines of deGennes, " //cr//parspace//&
                                ...
                                " Multiplied with a ROUSE blob, with Wl4 connected to a**4 * tau "
...
!write(*,*)"Nrouse:",q,t,temp,wl4,ne,re,sqt0,sqt
     ...
     th_locrep2nr = th_locrep2nr * sqt/sqt0
