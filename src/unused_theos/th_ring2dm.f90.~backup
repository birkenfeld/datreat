 FUNCTION th_ring2dm(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! >>>>> describe theory with >>>>>>> 
       ...
       th_explanation(idesc)  = " Dynamic scattering function for a polymer ring melt as developed in the PRL of S. Goossen with nue(nn) and Ap(ip)"
...
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(20,idesc) = "     0: Sqt, 1: msd+diff 2:msd-int " !//cr//parspace//&
...
! 
     ...
     call Nrouse_ring2dm(q,t,N, l, nu0, nue, wl4, ntrans, nwidth, pmin, pwidth, pneglim, pposlim, nuan, &
                                diff, r021, alpha, r022, beta, a_cross, Rg, Sq, Sqt, msd, msd_im)
...
! subroutines and functions entered here are private to this theory and share its variables 
       subroutine Nrouse_ring2dm(q,t,N, l, nu0, nue, wl4, ntrans, nwidth, pmin, pwidth, pneglim, pposlim, nuan, &
                                diff, r021, alpha, r022, beta, a_cross, Rg, Sq, Sqt, msd, msd_im)
!      ================================================================================================
!
...
!$OMP PARALLEL DO
  do ip=1,N2
    Ap(ip) = ( pneglim * 1d0/(1.0d0+exp((2*ip-pmin)/pwidth))   &
           ...
           * (-2d0* dble(N)**(2*nuan) *(l*q)**2/(3d0*pi**2))  !! HIER KEIN N**2nu OK ??
  enddo
!$OMP END PARALLEL DO
...
! and the com diffusion
       ...
       end subroutine Nrouse_ring2dm

 
 end function th_ring2dm
