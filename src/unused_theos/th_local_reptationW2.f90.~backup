 FUNCTION th_locrepw2(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
function local_reptation_lw(q, tx, B, L, nu, M, mode) result(val)
 ...
 if(mode == 0) then
   ...
   if( abs(nu-0.5d0) > epsilon(1.0) ) Write(*,*)"WARNING: locrepw2 mode = 3",mode," ignores nu= ",nu
   val = local_reptation(q, t, B, L)
 else
   write(*,*)"WARNING: locrepw2 mode = ",mode," NOT KNOWN! "
 endif
