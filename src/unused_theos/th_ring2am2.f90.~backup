 FUNCTION th_ring2am2(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! the internal parameter representation 
     ...
     double precision :: taue       ! tau at pmin                                                         
...
!       --------------> set the parameter names --->
        ...
        parnam (18) = 'mode    '  ! mode sqt oder msd                                               
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(11,idesc) = "ABS: tau at pmin" !//cr//parspace//&
        ...
        th_param_desc(18,idesc) = "0: sqt, 1: msd, 2:msd-intern" !//cr//parspace//&
...
! subroutines and functions entered here are private to this theory and share its variables
       ...
       subroutine Nrouse_ring2am2(q,t,N)
!      ================================================================
!
...
!
       ...
       double precision :: rate, tau_R, traf
...
!!$OMP PARALLEL DO PRIVATE(rate,traf)
       do ip=1,N/2
         ...
         msd_im = msd_im - ff2  /  dble(2*ip)**(1d0+1.d0)                      &
                          *  (f0*(1d0-traf)+finf*(traf))                       &
                          *  ewfac(ip)
       enddo
!$OMP END PARALLEL DO
...
!$OMP END PARALLEL DO
       ...
       end subroutine Nrouse_ring2am2

 end function th_ring2am2
