      function th_rousemode(x, pa, thnam, parnam, npar,  ini, nopar ,params,napar,mbuf)  
!     ========================================                          
!                                                                       
! -------> Rousemode analysis <--------                                 
!                                                                       
...
!       double precision w1,w2,w3,w4                                    
       double precision wei,wzw,wdr,wvi 
...
!          call rousmode(qzz,tau,temp,dr,xi,N,R,W,l,Sq,Sqt,w1,w2,w3,w4) 
          call rousmode(qzz,tau,temp,dr,xi,N,R,W,l,Sq,Sqt,              &
     &         wei,wzw,wdr,wvi)                                         
          sum = sum + fn*Sqt 
       ...
       if(sumnorm.gt.0.0d0) then 
          if(sqof0) then 
            ...
            th_rousemode = sum/sumnorm 
          endif 
       else 
          th_rousemode = 0 
       endif 
       th_rousemode = th_rousemode*a0 
...
!       subroutine rousmode(q,t,temp,Dr,xi,N,R, W, l,Sq,Sqt,w1,w2,w3,w4)
       subroutine rousmode(q,t,temp,Dr,xi,N,R, W, l,Sq,Sqt,             &
     &     wei,wzw,wdr,wvi)                                             
!      ==================================================               
!                                                                       
...
!                                                                       
       ...
       double precision wei,wzw,wdr,wvi,wmod 
!       double precision w1,w2,w3,w4,wmod                               
       integer N, nn,mm,p 
...
!            tau_p = 2*W*(1-cos((pi*p)/dfloat(N)))                      
            tau_p = 2*wmod*(1-cos((pi*p)/dfloat(N))) 
            a0    = -t*tau_p 
