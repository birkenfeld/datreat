 FUNCTION th_ring2dm6(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! the reout parameter representation 
     ...
     double precision :: mw
     double precision, parameter :: mw10 = 10d0 
     double precision :: diff0, diff_exp, nuegue, r0210
...
!       --------------> set the parameter names --->
        ...
        parnam ( 3) = 'r0210   '  ! reference mean squared displacement at first transition point to medium timed di
        ...
        parnam (21) = 'diff_exp'  ! diffusion Mw exp                      
        parnam (22) = 'nuegue  '  ! Guenza-exponent                      
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(21,idesc) = "ABS: diff_exp diff=diff0*(mw10/mw)**diff_exp " !//cr//parspace//&
        th_param_desc(22,idesc) = "ABS: r021=r02100*(mw/mw10)**nuegue " !//cr//parspace//&
...
! >>> extract: mw
      ...
      if(ier .ne. 0) then 
         write(*,*)"ERROR: ring2dm5 requires presence of parameter mw in data record!"
         return
      endif
      mw        = xh
...
! 
     ...
     call Nrouse_ring2dm6(q,t,N, l, nu0, nue, wl4, ntrans, nwidth, pmin, pwidth, pneglim, pposlim, nuan, &
...
! subroutines and functions entered here are private to this theory and share its variables 
       subroutine Nrouse_ring2dm6(q,t,N, l, nu0, nue, wl4, ntrans, nwidth, pmin, pwidth, pneglim, pposlim, nuan, &
                                diff, r021, alpha, r022, beta, a_cross, Rg, Sq, Sqt, msd, msd_im, Sqt0)
!      ================================================================================================
!
...
! and the com diffusion
       ...
       end subroutine Nrouse_ring2dm6

 
 end function th_ring2dm6
