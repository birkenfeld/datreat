 FUNCTION th_nrouspm2(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
!       --------------> set the parameter names --->
        ...
        parnam ( 7) = 'amatan1   '  ! minimum mode to be included                     
        parnam ( 8) = 'amatan2   '  ! minimum mode to be included                     
        parnam ( 9) = 'amatan3   '  ! minimum mode to be included                     
        parnam (10) = 'amatan4   '  ! minimum mode to be included                     
        parnam (11) = 'amatan5   '  ! minimum mode to be included                     
        parnam (12) = 'amatan6   '  ! minimum mode to be included                     
        parnam (13) = 'amatan7   '  ! minimum mode to be included                     
        parnam (14) = 'amatan8   '  ! minimum mode to be included                     
        parnam (15) = 'amatan9   '  ! minimum mode to be included                     
        parnam (16) = 'amatan10  '  ! minimum mode to be included                     
        parnam (17) = 'amatan11  '  ! minimum mode to be included                     
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc( 7,idesc) = "tan(mode amplitude) " !//cr//parspace//&
        th_param_desc( 8,idesc) = "tan(mode amplitude) " !//cr//parspace//&
        th_param_desc( 9,idesc) = "tan(mode amplitude) " !//cr//parspace//&
...
! ---- transfer parameters -----
      ...
      modeamp(1:11)  =  atan(abs(pa( 7:17)))*2/Pi !! possibly modify the first 11
...
! 
     ...
     call nrouspm2(q,t,temp,Dr,wl4,n_segmen,Re, W, l,labelarray, modeamp, Sq,Sqt)


     th_nrouspm2 = amplitu * sqt/sq
...
! ---- writing computed parameters to the record >>>
 ...
 CONTAINS 
       ...
       subroutine nrouspm2(q,t,temp,Dr,wl4,N,R, W, l,labelarray, modeamplitudes, Sq,Sqt)
!      ========================================================
!
