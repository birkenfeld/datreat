 FUNCTION th_locdgne2(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
!     Sqdebt = ampdebye * Sqdebt 
 ...
 ! write(*,*)"q,t=",q,t,"  sqt0, sqt=",sqt0,sqt, "debye=", Sqdeb0,Sqdebt
      th_locdgne2 = ampli * sqt/sqt0  * Sqdebt/Sqdeb0
...
! ---- writing computed parameters to the record >>>
      ...
      call        parset('wl4     ',sngl(Wr*l**4),iadda) !     "
