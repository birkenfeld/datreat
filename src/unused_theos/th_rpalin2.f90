 FUNCTION th_rpalin2(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
!       --------------> set the parameter names --->
        ...
        parnam ( 7+5) = 'locr2_b '  ! locrep2 parameter b
        parnam ( 8+5) = 'locr2_a '  ! locrep2 parameter a
        parnam ( 9+5) = 'locr2_ta'  ! locrep2 parameter tau
        parnam (10+5) = 'locr2_lz'  ! locrep2 parameter lz
        parnam (11+5) = 'locr2_te'  ! locrep2 parameter teps
        parnam (12+5) = 'nro_me  '  ! effective segments for Me-Modelling
        parnam (13+5) = 're_me   '  ! Re of Me (entangled strand Re)
        parnam (14+5) = 'wl4     '  ! Wl4 (local entanglement strand Re)
        parnam (15+5) = 'difflin '  ! center of mass diffusion
        parnam (16+5) = 'betadifl'  ! beta of linear polymer diff

        parnam (17+5) = 'lr2_b_c '  ! locrep2 parameter b for matrix c
        parnam (18+5) = 'lr2_a_c '  ! locrep2 parameter a for matrix c
        parnam (19+5) = 'lr2_ta_c'  ! locrep2 parameter tau for matrix c 
        parnam (20+5) = 'lr2_lz_c'  ! locrep2 parameter lz for matrix c 
        parnam (21+5) = 'lr2_te_c'  ! locrep2 parameter teps for matrix c 
        parnam (22+5) = 'nro_me_c'  ! effective segments for Me-Modelling for matrix c 
        parnam (23+5) = 're_me_c '  ! Re of Me (entangled strand Re) for matrix c 
        parnam (24+5) = 'wl4_c   '  ! Wl4 (local entanglement strand Re) for matrix c 
        parnam (25+5) = 'diffmatc'  ! center of mass diffusion for matrix c 
        parnam (26+5) = 'betadifc'  ! beta of linear polymer diff for matrix c 

        parnam (27+5) = 'mode    '  ! what to compute
        parnam (28+5) = 'modeex  '  ! selects way of representation in terms of nexp
        parnam (29+5) = 'nxpoints'  ! number of points to determine representation in terms of nexp
        parnam (30+5) = 'tzero   '  ! preliminary: effective zero time for S(Q,t=0=tzero)
        parnam (31+5) = 'tmaxrng '  ! maximum range that shall be spanned by creating the n-exp model
        parnam (32+5) = 'minrate '  ! minimum rate allowed in the exp models
...
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc( 5,idesc) = "NOT USED ! " !//cr//parspace//&
        ...
        th_param_desc( 8,idesc) = " NOT USED reference time for short time diffusion " !//cr//parspace//&
        ...
        th_param_desc( 7+5,idesc) = "locrep2 parameter b" !//cr//parspace//&
        th_param_desc( 8+5,idesc) = "locrep2 parameter a" !//cr//parspace//&
        th_param_desc( 9+5,idesc) = "locrep2 parameter tau" !//cr//parspace//&
        th_param_desc(10+5,idesc) = "locrep2 parameter lz" !//cr//parspace//&
        th_param_desc(11+5,idesc) = "locrep2 parameter teps" !//cr//parspace//&
        th_param_desc(12+5,idesc) = "effective segments for Me-Modelling" !//cr//parspace//&
        th_param_desc(13+5,idesc) = "Re of Me (entangle strand Re)" !//cr//parspace//&
        th_param_desc(14+5,idesc) = "Wl4 entaglement strand" !//cr//parspace//&
        th_param_desc(15+5,idesc) = "centre-of-mass diffusion linear" !//cr//parspace//&
        th_param_desc(16+5,idesc) = "betadiff linear" !//cr//parspace//&

        th_param_desc(17+5,idesc) = "locrep2 parameter b  for matrix polymer (c)" !//cr//parspace//&
        th_param_desc(18+5,idesc) = "locrep2 parameter a  for matrix polymer (c)" !//cr//parspace//&
        th_param_desc(19+5,idesc) = "locrep2 parameter tau for matrix polymer (c)" !//cr//parspace//&
        th_param_desc(20+5,idesc) = "locrep2 parameter lz  for matrix polymer (c)" !//cr//parspace//&
        th_param_desc(21+5,idesc) = "locrep2 parameter teps  for matrix polymer (c)" !//cr//parspace//&
        th_param_desc(22+5,idesc) = "effective segments for Me-Modelling  for matrix polymer (c)" !//cr//parspace//&
        th_param_desc(23+5,idesc) = "Re of Me (entangle strand Re)  for matrix polymer (c)" !//cr//parspace//&
        th_param_desc(24+5,idesc) = "Wl4 entaglement strand  for matrix polymer (c)" !//cr//parspace//&
        th_param_desc(25+5,idesc) = "centre-of-mass diffusion linear  for matrix polymer (c)" !//cr//parspace//&
        th_param_desc(26+5,idesc) = "betadiff linear  for matrix polymer (c)" !//cr//parspace//&

        th_param_desc(27+5,idesc) = "mode: 0 normal, >0 S(x=Q,tau) 1 lin, 2 star 3 rpa" !//cr//parspace//&
        th_param_desc(28+5,idesc) = "modex: number of exps to represent the undistrurbed S(q,t) relaxation curves" !//cr//parspace//&
        th_param_desc(29+5,idesc) = "number of points to determine representation in terms of nexp" !//cr//parspace//&
        th_param_desc(30+5,idesc) = "preliminary: effective zero time for S(Q,t=0=tzero)" //cr//parspace//&
        ...
        th_param_desc(31+5,idesc) = " maximum range that shall be spanned by creating the n-exp model" !//cr//parspace//&
        th_param_desc(32+5,idesc) = " minimum rate allowed in the exp models" !//cr//parspace//&
...
! ---- transfer parameters -----
      ...
      nrouseff = nint(pa( 3))
      plimit   = abs( pa( 4))
      diffrous = abs( pa( 5))        ! OBSOLET
      diff        = abs( pa (6) )    ! in A**2/ns
      r02         = abs( pa (7) )
      tc          = abs( pa (8) )
      nu_subdiff  = abs( pa (9) )
      a_cross     = abs( pa (10) )
      ...
      locr2_a  = abs( pa( 8+5))
      locr2_ta = abs( pa( 9+5))
      locr2_lz = abs( pa(10+5))
      locr2_te = abs( pa(11+5))
      nro_me   = nint(pa(12+5))
      re_me    = abs( pa(13+5))
      wl4      = abs( pa(14+5))
      difflin  = abs( pa(15+5))
      betadifl = abs( pa(16+5))

      lr2_b_c  = abs( pa(17+5))
      lr2_a_c  = abs( pa(18+5))
      lr2_ta_c = abs( pa(19+5))
      lr2_lz_c = abs( pa(20+5))
      lr2_te_c = abs( pa(21+5))
      nro_me_c = nint(pa(22+5))
      re_me_c  = abs( pa(23+5))
      wl4_c    = abs( pa(24+5))
      diffmatc = abs( pa(25+5))
      betadifc = abs( pa(26+5))

      mode     = nint(pa(27+5))
      modeex   = nint(pa(28+5))
      nxpoints = nint(pa(29+5))
      t0       = abs( pa(30+5))
      tmax     = abs( pa(31+5))
      rlow     = abs( pa(32+5))  ! parameter in rpa_laplace
...
i1:  if( mode == 0 ) then     ! normal spin-echo
      ...
      allparams(1:48) = [ wl4rous, dble(nrouseff), diffrous, locr2_b, locr2_a, locr2_ta, locr2_lz, locr2_te, &
                         ...
                         diff, r02, tc, nu_subdiff, a_cross, beta_q ]
