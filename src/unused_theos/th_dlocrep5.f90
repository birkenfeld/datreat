 FUNCTION th_dlocrep5(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! the reout parameter representation 
   ...
   double precision :: sqtloc, sqtloc0, sqtrous, sqtrous0, wout, dne
   integer          :: nz, nr
   integer          :: mode
   integer          :: iw
