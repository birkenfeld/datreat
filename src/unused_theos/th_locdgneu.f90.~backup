 FUNCTION th_locdgneu(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! >>>>> describe parameters >>>>>>> 
        ...
        th_param_desc(20,idesc) = "modulation between eq 43/46 for Lrep" !/ !//cr//parspace//&
...
!     Sqdebt = ampdebye * Sqdebt 
 ...
 ! write(*,*)"q,t=",q,t,"  sqt0, sqt=",sqt0,sqt, "debye=", Sqdeb0,Sqdebt
      th_locdgneu = ampli * sqt/sqt0  * Sqdebt/Sqdeb0
