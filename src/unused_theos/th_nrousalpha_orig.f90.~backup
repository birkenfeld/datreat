 FUNCTION th_nrousalpha_orig(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
!  Rouse by discrete summation with mode restriction
!  Rouse, Doi_Edwards
      use theory_description 
      implicit none 
      real    :: th_nrousalpha_orig
...
! 
     ...
     select case(mode)
       case(0)
         call nrousalpha_orig(q,t,temp,Dr,wl4,n_segmen,Re, W, l,pmin,pmax, Sq,Sqt)
         th_nrousalpha_orig = amplitu * sqt/sq
       case(1)
         th_nrousalpha_orig = alpha(t)
       case default 
...
! ---- writing computed parameters to the record >>>
 ...
 CONTAINS 
       ...
       subroutine nrousalpha_orig(q,t,temp,Dr,wl4,N,R, W, l,pmin,pmax, Sq,Sqt)
!      ========================================================
!
...
! the model
 ...
 end function th_nrousalpha_orig
