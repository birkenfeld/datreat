 FUNCTION th_reptest3(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
!  generalized local reptest3n expression along the lines of deGennes, 
...
! >>>>> describe theory with >>>>>>> 
       ...
       th_explanation(idesc)  = " generalized local reptest3n expression along the lines of deGennes, " //cr//parspace//&
