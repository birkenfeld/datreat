 FUNCTION th_ring2am3(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
...
! subroutines and functions entered here are private to this theory and share its variables
       ...
       subroutine Nrouse_ring2am3(q,t,N)
!      ================================================================
!
...
!
       ...
       double precision :: rate, traf ! , tau_R, W, Ne0, taue
...
!$OMP END PARALLEL DO
       ...
       end subroutine Nrouse_ring2am3

 end function th_ring2am3
