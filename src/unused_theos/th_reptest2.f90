 FUNCTION th_reptest2(x, pa, thnam, parnam, npar,ini, nopar ,params,napar,mbuf)
!================================================================================
!  generalized local reptest2n expression along the lines of deGennes, 
...
! >>>>> describe theory with >>>>>>> 
       ...
       th_explanation(idesc)  = " generalized local reptest2n expression along the lines of deGennes, " //cr//parspace//&
...
! 
      ...
      sqt =  reptation2_sqt(q,t, N, a, Ne, Re, wl4, alpha0, talphamax,talphawd) 

      th_reptest2 = ampli * sqt(2)/sqt(1)
