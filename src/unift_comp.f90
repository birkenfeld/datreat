...
!!! Fouriertransform of data !!
      ...
      DO it=1,mwert 
        t=(it-1)*dt 
        tv(it) = t
        call fourier(es1,ss1,ds1,ns1,t,ft1,ft2,fts(it),dfts(it))
...
!!! Fouriertransform of res !!
      ...
      if(ipoint_re.ne.0) then
        DO it=1,mwert 
          t=(it-1)*dt 
          tv(it) = t
          call fourier(er1,sr1,dr1,nr1,t,ft1,ft2,ftr(it),dftr(it))
          ...
          if(iout().gt.0) then          
            ...
            WRITE(6,'(i4,7f10.3)') it,t,ft1,ft2,ftr(it),ft2/ft1,ftr(it)/ftr(1),dftr(it)/ftr(it)
          endif                                                                
        END DO 
