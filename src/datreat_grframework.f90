...
! Parameters for GR-framework, colors are still missing
  ...
  double precision              :: tex_fak                       = 1.3d0
...
!      --- doplo = false  means: set parameters only ---
      ...
      if(found('help    ')) then 
       ...
       write(6,*)'=      texfak <val>   :  enlarge factor for tex expression (start with $     ='
...
!       write(6,*)'=      last           :  read parameters form last session                   ='
       ...
       write(6,*)'=       to restart creation of auto numbered series datreat_plot##.pdf remove='
       write(6,*)'=       or edit file: datreat_plot_counter                                   ='
       write(6,*)'= VERSION 3.0                                                                ='
       write(6,*)'=============================================================================='
       return
      endif
...
!   ---> txon, txoff are from old version and not documented any more <-
          ...
          if(vname(i).eq.'texfak  ') tex_fak= rpar(j)
...
! to be modernized
          ...
          read(ioppar,*,end=99,err=99) tex_fak  ! dies nach oben
...
99        continue
       ...
       subroutine writeplotpar()
         ...
         open(newunit=ioppar, file=LAST_PPAR)
          ...
          write(ioppar,*) tex_fak      ! hier nach oben !
